...
<script src='js/expCreate.js'></script>
</head>
<body>
<%
...
%> 
	...
	<div class='ui padded content grid' style='height: 90%;'>
				...
				<div class="item">
					...
					<div class="menu">
						<a id='menu_expsearch' class="item">Manage</a> <a id='menu_expnew'
							class="active item">Create new</a> <a id='menu_expnew_adv'
							class="item">Create new (Adv.)</a>
					</div>
				</div>
				<div class="item">
		...
		<div id='contents_expnew' class='fourteen wide stretched column'>

			<!-- <div id='contents_expnew' class='ui grid' style='height: 100%;'>  -->
										...
										<div class='field'>
											<div class='ui checkbox'>
												<input tabindex='0' name='tcontrol' type='checkbox'
													title='Check if this is the control variant'> <label>Is
													Control</label>
											</div>
										</div>
